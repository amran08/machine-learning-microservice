[![CircleCI](https://circleci.com/gh/amran08/machine-learning-microservice.svg?style=svg)](https://circleci.com/gh/amran08/machine-learning-microservice)
...
* `screenshot` diectory contains results command executions 
